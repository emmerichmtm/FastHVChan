...
The C port in `c/` is a standalone C99 library (no dependencies beyond libm)
covering `chan_hypervolume.py` only. It is validated both against brute-force
inclusion-exclusion and against randomised cases generated by the Python
implementation; see `c/README.md`.
